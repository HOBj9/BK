...
export const buttonVariants = {
  ...
  outline:
    'border-2 border-brand-600/80 text-brand-800 bg-white/90 backdrop-blur-sm hover:border-brand-500 hover:bg-brand-50 focus-visible:ring-brand-500',
  ghost:
    'text-brand-800 hover:bg-brand-50/80 focus-visible:ring-brand-500',
  glass:
...
export const buttonBase =
  'relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-xl font-semibold tracking-tight transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2';

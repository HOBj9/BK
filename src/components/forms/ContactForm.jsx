...
const inputClass =
  'w-full rounded-xl border border-slate-200/90 bg-white px-4 py-3.5 text-slate-900 shadow-sm transition-all duration-300 placeholder:text-slate-400 hover:border-slate-300 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/25 focus:shadow-md focus:shadow-brand-500/5';
  ...
  if (submitted) {
    return (
      ...
      >
        ...
        <h3 className="mt-4 text-xl font-bold text-slate-900">Message envoyé</h3>
